# DESIGN.md Guide Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Write `DESIGN.md-GUIDE.md` in the project root — a practitioner's guide to authoring high-quality DESIGN.md files, distilled from 70+ real-world examples in github.com/VoltAgent/awesome-design-md.

**Architecture:** Single markdown file in three layers: (1) introduction and context, (2) nine-section reference with purpose, requirements, annotated examples, and YAML variant notes, (3) cross-cutting patterns and anti-patterns distilled from real files. Closes with a quick-start checklist.

**Tech Stack:** Plain markdown, no build tooling. Research already done and available in the spec at `docs/superpowers/specs/2026-05-02-design-md-guide-design.md`.
...
|--------|------|----------------|
| Create | `DESIGN.md-GUIDE.md` | The complete guide — all three layers |
| Reference | `docs/superpowers/specs/2026-05-02-design-md-guide-design.md` | Source of truth for structure decisions |

---

## Task 1: Scaffold the file and write Layer 1 (Introduction)

**Files:**
- Create: `DESIGN.md-GUIDE.md`

- [ ] **Step 1: Create the file with the introduction**

Write the following content to `DESIGN.md-GUIDE.md`:
...
- [ ] **Step 2: Verify the file exists and the intro reads cleanly**

Run: `wc -l DESIGN.md-GUIDE.md`
Expected: ~25 lines
...
```bash
git init
git add DESIGN.md-GUIDE.md
git commit -m "docs: scaffold DESIGN.md-GUIDE.md with introduction"
```

---

## Task 2: Write Layer 2 — Section 1 reference (Visual Theme & Atmosphere)

**Files:**
- Modify: `DESIGN.md-GUIDE.md`

- [ ] **Step 1: Append Section 1 reference**

Append to `DESIGN.md-GUIDE.md`:
...
Run: `grep -n "Visual Theme" DESIGN.md-GUIDE.md`
Expected: line found in the 30s range

- [ ] **Step 3: Commit**

```bash
git add DESIGN.md-GUIDE.md
git commit -m "docs: add Section 1 reference (Visual Theme & Atmosphere)"
```

---

## Task 3: Write Layer 2 — Section 2 reference (Color Palette & Roles)

**Files:**
- Modify: `DESIGN.md-GUIDE.md`

- [ ] **Step 1: Append Section 2 reference**
...
Run: `grep -n "Color Palette" DESIGN.md-GUIDE.md`
Expected: line found
...
```bash
git add DESIGN.md-GUIDE.md
git commit -m "docs: add Section 2 reference (Color Palette & Roles)"
```

---

## Task 4: Write Layer 2 — Section 3 reference (Typography Rules)

**Files:**
- Modify: `DESIGN.md-GUIDE.md`

- [ ] **Step 1: Append Section 3 reference**
...
Run: `grep -n "Typography Rules" DESIGN.md-GUIDE.md`
Expected: line found
...
```bash
git add DESIGN.md-GUIDE.md
git commit -m "docs: add Section 3 reference (Typography Rules)"
```

---

## Task 5: Write Layer 2 — Section 4 reference (Component Stylings)

**Files:**
- Modify: `DESIGN.md-GUIDE.md`

- [ ] **Step 1: Append Section 4 reference**
...
Run: `grep -n "Component Stylings" DESIGN.md-GUIDE.md`
Expected: line found
...
```bash
git add DESIGN.md-GUIDE.md
git commit -m "docs: add Section 4 reference (Component Stylings)"
```

---

## Task 6: Write Layer 2 — Sections 5–6 reference (Layout, Depth)
...
**Writing guidance for both sections:**
- Layout: the whitespace philosophy prose is what separates distinctive systems from generic ones — don't skip it
- Elevation: name your shadow levels; "shadow-sm / shadow-md / shadow-lg" is more useful to agents than anonymous CSS values
- Elevation: always include the shadow philosophy — agents need to understand *why* the shadow color was chosen to avoid replacing it with a neutral gray
...
Run: `grep -n "Layout Principles\|Depth & Elevation" DESIGN.md-GUIDE.md`
...
```bash
git add DESIGN.md-GUIDE.md
git commit -m "docs: add Sections 5–6 reference (Layout, Depth & Elevation)"
```

---

## Task 7: Write Layer 2 — Sections 7–8 reference (Do's/Don'ts, Responsive)
...
- Name what stays the same across breakpoints, not just what changes (e.g., "weight 300 maintained" tells the agent not to bump weight on mobile)
...
Run: `grep -n "Do's and Don'ts\|Responsive Behavior" DESIGN.md-GUIDE.md`
Expected: both lines found
...
```bash
git add DESIGN.md-GUIDE.md
git commit -m "docs: add Sections 7–8 reference (Do's/Don'ts, Responsive)"
```

---

## Task 8: Write Layer 2 — Section 9 reference (Agent Prompt Guide)
...
Run: `grep -n "Agent Prompt Guide" DESIGN.md-GUIDE.md`
Expected: line found
...
```bash
git add DESIGN.md-GUIDE.md
git commit -m "docs: add Section 9 reference (Agent Prompt Guide)"
```

---

## Task 9: Write Layer 3 — Patterns & Anti-Patterns

**Files:**
- Modify: `DESIGN.md-GUIDE.md`

- [ ] **Step 1: Append Layer 3**
...
Run: `grep -n "Patterns & Anti-Patterns\|Anti-Pattern Summary" DESIGN.md-GUIDE.md`
Expected: both lines found
...
```bash
git add DESIGN.md-GUIDE.md
git commit -m "docs: add Layer 3 (Patterns & Anti-Patterns)"
```

---

## Task 10: Write closing checklist and finalize

**Files:**
- Modify: `DESIGN.md-GUIDE.md`

- [ ] **Step 1: Append closing checklist**
...
- [ ] **Step 2: Final line count and section check**

Run: `wc -l DESIGN.md-GUIDE.md && grep "^### [0-9]" DESIGN.md-GUIDE.md`
Expected: 600–900 lines; all 9 section headers present

- [ ] **Step 3: Final commit**

```bash
git add DESIGN.md-GUIDE.md docs/superpowers/
git commit -m "docs: complete DESIGN.md-GUIDE.md with all sections and checklist"
```
